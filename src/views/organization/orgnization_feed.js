...
import { Container, Header, Content, Sidebar, Placeholder, Whisper, Tooltip, Avatar, Icon, Badge, Modal, Button, Panel, Notification, Dropdown, Drawer, IconButton } from 'rsuite';
                ...
                <>
                    ...
                    <Container>
                        {state.currentWindowWidthState > 700
                            ...
                            :
                            <>
                            <IconButton className="mobile_nav_bar" onClick={()=> setOpenMobileDrawer(true)} icon={<Icon icon="bars"/>}></IconButton>
                                <Drawer
                                    size={'xs'}
                                    placement={'left'}
